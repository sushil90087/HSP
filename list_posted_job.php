		...
		<div class="col-sm-8">
			...
			?>
					<div class="one-block-data" style="border-style: solid;display:block">
						<?php
						echo "Your next posted job is---" . "<br>";
						...
						?>
										<div style="border-style: groove;">
											<?php
											echo "  <b>Introduction=</b>" . $rowlistappliedcandidate["Introduction"];
											echo "  <b>MinimumPackage=</b>" . $rowlistappliedcandidate["MinimumPackage"];
											echo "  <b>PreferredLocation=</b>" . $rowlistappliedcandidate["PreferredLocation"];
											echo "  <b>PreferredCompany=</b>" . $rowlistappliedcandidate["PreferredCompany"];
											echo "  <b>JoiningTimeInMonth=</b>" . $rowlistappliedcandidate["JoiningTimeInMonth"];
											echo "  <b>SkillSet=</b>" . $rowlistappliedcandidate["SkillSet"];
											echo "  <b>NumberOfYearsExperience=</b>" . $rowlistappliedcandidate["NumberOfYearsExperience"];
											echo "  <b>LinkedInId=</b>" . $rowlistappliedcandidate["LinkedInId"];
											$ResumeCv = $rowlistappliedcandidate["ResumeCv"];
											?>
											<a href=<?php echo $ResumeCv ?> download="Resume">Download Resume</a>
										</div>
						<?php
